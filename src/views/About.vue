...
function generateArray() {
    ...
    return arr2D
        ...
        <p>In this example, you can see our first idea for representing the maze. We would simply use characters to represent each state of the maze cells. A '#' would represent a wall, 'S' and 'F' would be start and finish respectively, and '0' would represent and empty cell. We could also use '@' to notate cells we have already traveled to. To access individual cells of the maze we target the vertical and then horizontal positon in the array. So the first cell would be 'arr2D[0][0]'</p>
        <p></p>
        <h3>Attempt #1</h3>
